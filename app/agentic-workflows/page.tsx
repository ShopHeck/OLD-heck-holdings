...
const service = servicePages['agentic-workflows'];

export const metadata: Metadata = {
  title: `${service.title} | Heck Holdings`,
  description: service.description,
  alternates: { canonical: '/agentic-workflows' },
  openGraph: { title: `${service.title} | Heck Holdings`, description: service.description, url: 'https://heckholdings.com/agentic-workflows' }
};
...
function ServicePage({ service }: { service: typeof servicePages['agentic-workflows'] }) {
  return (
