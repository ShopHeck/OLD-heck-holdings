...
const service = servicePages['ai-agents'];

export const metadata: Metadata = {
  title: `${service.title} | Heck Holdings`,
  description: service.description,
  alternates: { canonical: '/ai-agents' },
  openGraph: { title: `${service.title} | Heck Holdings`, description: service.description, url: 'https://heckholdings.com/ai-agents' }
};
...
function ServicePage({ service }: { service: typeof servicePages['ai-agents'] }) {
  return (
