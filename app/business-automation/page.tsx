...
export const metadata: Metadata = {
  ...
  openGraph: { title: `${service.title} | Heck Holdings`, description: service.description, url: 'https://heckholdings.com/business-automation' }
};
...
function ServicePage({ service }: { service: typeof servicePages['business-automation'] }) {
  return (
